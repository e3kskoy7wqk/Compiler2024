...
TREEOP(TN_EmptyStmt  , tkNone,   ";"          ,CEE_NOP   , 0,TNK_NONE)
...
TREEOP(TN_CompUnit   , tkNone,   "CompUnit"   ,CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_VarDecl    , tkNone,   "VarDecl"    ,CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_VarDef     , tkNone,   "VarDef"     ,CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_ConstInitVal, tkNone,   "ConstInitVal",CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_InitVal    , tkNone,   "InitVal"    ,CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_FuncBody   , tkNone,   "FuncBody"   ,CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_FuncDef    , tkNone,   "FuncDef"    ,CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_FuncFParams, tkNone,   "FuncFParams",CEE_NOP   , 0,TNK_NONE)
TREEOP(TN_FuncDecl   , tkNone,   "FuncDecl"   ,CEE_NOP   , 0,TNK_NONE)
/*****************************************************************************/
#undef  TREEOP
/*****************************************************************************/
